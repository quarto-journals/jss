...
abstract: |
  ...
  For outlining the typical structure of a JSS article some brief text snippets are employed that have been inspired by @ZeileisKleiberJackman2008, discussing count data regression in \proglang{R}. Editorial comments and instructions are marked by vertical bars.

keywords: [JSS, style guide, comma-separated, not capitalized, "\\proglang{R}"]
keywords-plain: [JSS, style guide, comma-separated, not capitalized, R]
...
## More technical details {#sec-techdetails}
